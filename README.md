...
* **License:** MIT © M. Zia
* **Attribution Notice:** All code in this repository was generated by **Google Antigravity**. The maintainer does not claim authorship or personal credit for the code authored by the AI.
